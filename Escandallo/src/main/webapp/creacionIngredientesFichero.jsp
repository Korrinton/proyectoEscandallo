    ...
    while ((linea = br.readLine()) != null) {
        ...
        if (partes.length == 3) {
            ...
            try {
                ...
                String sqlVerificar = "SELECT COUNT(*) FROM ingredientes WHERE nombre_ingrediente = ?";
                ...
                if (!existe) {
                    String sqlInsertar = "INSERT INTO ingredientes (nombre_ingrediente, unidad_medida, costo_unidad) VALUES (?, ?, ?)";
